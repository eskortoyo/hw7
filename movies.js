firebase.auth().onAuthStateChanged(async function(user) {
  if (user) {
    ...
    document.querySelector('.sign-in-or-sign-out').innerHTML = `
      <button class="bg-blue-300 hover:bg-blue-600 text-white px-4 py-2 rounded-xl"><a href='#' class="sign-out-button text-white">Sign Out</a></button>
    `
    ...
    console.log(`There are ${movies.length} movies in the array.`)
